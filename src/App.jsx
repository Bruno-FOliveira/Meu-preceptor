...
"criar João 67a leito 12, ICC descomp, HAS DM2"
"João PA 130x80 FC 88, adicionar Furosemida 40mg EV"
"Maria piora crítico — solicitar UTI"'}
            rows={3}
        ...
        <div style={{display:"flex",gap:8,alignItems:"flex-end"}}>
          <div style={{flex:1}}>
            <textarea
              ...
              placeholder={'Digite livremente — a IA entende tudo:
"criar João, 67a, leito 12, ICC descompensada, HAS DM2"
"João PA 130x80 FC 88, adicionar Furosemida 40mg"
"Pedro piora, crítico, pendência: solicitar UTI"
"dar alta Maria" / "remover Carlos"'}
              rows={3}
