        ...
        <div>
          ...
          {uploadMode === "rag" && (
            <div style={{ marginTop: 16, padding: 14, background: C.surface2, borderRadius: 12, fontSize: 12, color: C.textMuted, lineHeight: 1.7 }}>
              ...
              1. O Gemini extrai o texto do PDF (em blocos para arquivos grandes)<br />
              ...
              <strong style={{ color: C.yellow }}>⏱️ Tempo estimado por tamanho:</strong><br />
              📄 &lt;10MB (artigo/guideline): ~2-5 min<br />
              📚 10-20MB: ~5-10 min (2 blocos)<br />
              📖 20-40MB (Abramed): ~15-30 min (4-5 blocos)<br />
              📚 &gt;40MB (USP volumes): ~30-60 min (blocos automáticos)<br /><br />
              <strong style={{ color: C.green }}>✅ Arquivos grandes:</strong> processados automaticamente em blocos — não feche o app durante o processo!
            </div>
          )}
        </div>
      )}
