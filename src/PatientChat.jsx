    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", fontFamily: "'Georgia',serif" }}>
        ...
        <div style={{ display: "flex", gap: 6, padding: "0 14px 8px", overflowX: "auto" }}>
          {previews.map((p, i) => (
            <div key={i} style={{ position: "relative", flexShrink: 0 }}>
              {p ? <img src={p} alt="" style={{ height: 56, borderRadius: 8 }} /> : <div style={{ height: 56, width: 56, background: C.accentDim, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>📄</div>}
      ...
      <div style={{ padding: "10px 14px", borderTop: `1px solid ${C.border}`, background: C.surface }}>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 8, overflowX: "auto" }}>
          ...
          <button onClick={() => fileRef.current?.click()} style={{ background: C.accentDim, border: `1px solid ${C.border}`, borderRadius: 8, color: C.accent, padding: "6px 10px", cursor: "pointer", fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" }}>📸 Foto</button>
          <button
